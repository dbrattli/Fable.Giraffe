...
let tests: (string * (unit -> System.Threading.Tasks.Task<unit>)) list =
    [ "test remoting: GET \"/IServer/meaningOfLife\" returns 42", ``test remoting: GET "/IServer/meaningOfLife" returns 42``
      "test remoting: GET \"/IServer/getNumbers\" returns numbers", ``test remoting: GET "/IServer/getNumbers" returns numbers``
      "test remoting: POST \"/greet\" returns \"Hello World\"", ``test remoting: POST "/greet" returns "Hello World"``
      "test remoting: POST \"/updateModel\" returns updated model", ``test remoting: POST "/updateModel" returns updated model``
      "test remoting: POST \"/divide\" returns float", ``test remoting: POST "/divide" returns float`` ]
