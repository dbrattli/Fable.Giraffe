...
let ``test route: GET "/" returns "Hello World"`` () =
    ...
    task {
        ...
        | Some _ -> (readBody ()) |> equal expected
    }
...
let tests: (string * (unit -> System.Threading.Tasks.Task<unit>)) list =
    [ "test route: GET \"/\" returns \"Hello World\"", ``test route: GET "/" returns "Hello World"``
      "test route: GET \"/foo\" returns \"bar\"", ``test route: GET "/foo" returns "bar"``
      "test route: GET \"/FOO\" returns 404 \"Not found\"", ``test route: GET "/FOO" returns 404 "Not found"``
      "test GET \"/JSON\" returns \"BaR\"", ``test GET "/JSON" returns "BaR"``
      "test routex: GET \"/\" returns \"Hello World\"", ``test routex: GET "/" returns "Hello World"``
      "test routex: GET \"/foo\" returns \"bar\"", ``test routex: GET "/foo" returns "bar"``
      "test routex: GET \"/FOO\" returns 404 \"Not found\"", ``test routex: GET "/FOO" returns 404 "Not found"``
      "test routex: GET \"/foo///\" returns \"bar\"", ``test routex: GET "/foo///" returns "bar"``
      "test routex: GET \"/foo2\" returns \"bar\"", ``test routex: GET "/foo2" returns "bar"``
      "test routeCix: GET \"/CaSe///\" returns \"right\"", ``test routeCix: GET "/CaSe///" returns "right"``
      "test routef: GET \"/foo/blah blah/bar\" returns \"blah blah\"", ``test routef: GET "/foo/blah blah/bar" returns "blah blah"``
      "test routef: GET \"/foo/johndoe/59\" returns \"Name: johndoe, Age: 59\"",
      ``test routef: GET "/foo/johndoe/59" returns "Name: johndoe, Age: 59"``
      "test routef: GET \"/foo/b%2Fc/bar\" returns \"b%2Fc\"", ``test routef: GET "/foo/b%2Fc/bar" returns "b%2Fc"``
      "test routef: GET \"/foo/a%2Fb%2Bc.d%2Ce/bar\" returns \"a%2Fb%2Bc.d%2Ce\"",
      ``test routef: GET "/foo/a%2Fb%2Bc.d%2Ce/bar" returns "a%2Fb%2Bc.d%2Ce"``
      "test routef: GET \"/foo/%O/bar/%O\" returns \"Guid1: ..., Guid2: ...\"",
      ``test routef: GET "/foo/%O/bar/%O" returns "Guid1: ..., Guid2: ..."``
      "test routef: GET \"/foo/%u/bar/%u\" returns \"Id1: ..., Id2: ...\"",
      ``test routef: GET "/foo/%u/bar/%u" returns "Id1: ..., Id2: ..."``
      "test routef: GET \"/foo/bar/baz/qux\" returns 404 \"Not found\"", ``test routef: GET "/foo/bar/baz/qux" returns 404 "Not found"``
      "test POST \"/POsT/1\" returns \"1\"", ``test POST "/POsT/1" returns "1"``
      "test POST \"/POsT/523\" returns \"523\"", ``test POST "/POsT/523" returns "523"``
      "test subRoute: Route with empty route", ``test subRoute: Route with empty route``
      "test subRoute: Normal nested route after subRoute", ``test subRoute: Normal nested route after subRoute``
      "test subRoute: Route after subRoute has same beginning of path", ``test subRoute: Route after subRoute has same beginning of path``
      "test subRoute: Nested sub routes", ``test subRoute: Nested sub routes``
      "test subRoute: Multiple nested sub routes", ``test subRoute: Multiple nested sub routes``
      "test subRoute: Route after nested sub routes has same beginning of path",
      ``test subRoute: Route after nested sub routes has same beginning of path``
      "test subRoute: routef inside subRoute", ``test subRoute: routef inside subRoute``
      "test subRoutef: GET \"/\" returns \"Not found\"", ``test subRoutef: GET "/" returns "Not found"``
      "test subRoutef: GET \"/bar\" returns \"foo\"", ``test subRoutef: GET "/bar" returns "foo"``
      "test subRoutef: GET \"/John/5/foo\" returns \"bar\"", ``test subRoutef: GET "/John/5/foo" returns "bar"``
      "test subRoutef: GET \"/en/10/Julia\" returns \"Hello Julia! Lang: en, Version: 10\"",
      ``test subRoutef: GET "/en/10/Julia" returns "Hello Julia! Lang: en, Version: 10"``
      "test subRoutef: GET \"/en/10/api/Julia\" returns \"Hello Julia! Lang: en, Version: 10\"",
      ``test subRoutef: GET "/en/10/api/Julia" returns "Hello Julia! Lang: en, Version: 10"``
      "test subRouteCi: Non-filtering handler after subRouteCi is called",
      ``test subRouteCi: Non-filtering handler after subRouteCi is called``
      "test subRouteCi: Nested route after subRouteCi is called", ``test subRouteCi: Nested route after subRouteCi is called``
      "test subRouteCi: Nested route after subRouteCi is still case sensitive",
      ``test subRouteCi: Nested route after subRouteCi is still case sensitive``
      "test subRouteCi: Nested routeCi after subRouteCi is called", ``test subRouteCi: Nested routeCi after subRouteCi is called`` ]
